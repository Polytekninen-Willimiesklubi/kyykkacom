...
from backend.utils import MATCH_TYPES, PLAYOFF_FORMAT
...
class SuperWeekend(models.Model):
    ...
    super_weekend_playoff_format = models.IntegerField(default=0, blank=True, null=True, choices=MATCH_TYPES)
