<template>
  <v-dialog v-model="dialog" persistent max-width="600px">
    ...
    <v-card title="Rekisteröityminen" subtitle="Kaikki kentät pakollisia">
      <v-form validate-on="submit" @submit.prevent="awaitSubmitCheck()" ref="form">
        <v-container>
          <v-row>
            <v-col>
              <v-alert :model-value="alert" type="error" transition="scale-transition" outlined>
