      ...
      <v-col>
        <v-card v-if="dataReady">
          <v-row>
            <v-col>
              ...
              <v-icon v-if="showEdit" @click="showInput = !showInput" icon="mdi-pencil">
                <v-tooltip activator="parent" location="right" text="Muokkaa tulosta" />
              </v-icon>
            </v-col>
          </v-row>
          <v-row justify="center" align="center">
            <v-col class="ml-5">
              <figure>
                <v-img src="@/assets/kyykkalogo120px.png" height="120px" />
                <figcaption class="d-flex justify-center ma-2" v-if="matchData.home_score_total">
