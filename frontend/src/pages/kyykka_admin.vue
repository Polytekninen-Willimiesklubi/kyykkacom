    ...
    <v-card elevation="1">
      ...
      <v-window v-model="tab">
        <v-window-item :key="0" :value="0">
          ...
          <v-row>
            <v-col v-for="(listItem, index) in adminStore.regularSeasonTeams" :key="index" cols="4">
        ...
        <v-window-item :key="1" :value="1">
          <v-tabs v-model="subTab" fixed-tabs color="black">
          ...
          <v-window v-model="subTab">
            <v-window-item :key="0" :value="0">
              ...
              <v-row>
                ...
                <v-col cols="9">
                  <v-row>
                    <v-col
                      v-for="(listItem, index) in adminStore.superWeekendTeams"
                      :key="index"
                      :cols="4"
                    >
                      <v-card class="ml-10" elevated width="300px">
            ...
            <v-window-item :key="1" :value="1">
              ...
              >
                  ...
                  <v-col cols="2">
                    <v-menu v-model="menu" :close-on-content-click="false">
                      ...
                      <v-date-picker
                        v-model="selectDate"
                        @update:model-value="
                          ((menu = !menu), (selectDate = String(selectDate).split('T')[0]))
                        "
                      />
                    </v-menu>
                  </v-col>
                  <v-col cols="2">
                    <v-menu v-model="menuTime" :close-on-content-click="false">
                      <template #activator="{ props: activatorProps }">
                        <v-combobox
                          v-model="selectTime"
                          label="Peliaika"
                ...
                <v-btn type="submit" class="ma-2" text="Syötä tulos" color="error" />
              </v-form>
            </v-window-item>
            ...
            <v-window-item :key="3" :value="3">
              ...
              <h3 class="pl-10 pt-3">
                HUOM! Tarkista seedaus numero formaatista (Kysy Totilta :D)
              </h3>
              <h3 class="pl-10 pt-1">
                Vain playoff seedauksella on väliä, eli ne jotka jää ulkopuolella voi olla miten
                lystää.
              </h3>
                  ...
                  <template #item="{ element, index }">
                    <v-row style="border: solid; margin-bottom: 2px; border-width: 2px">
                      ...
                      <v-col align="right" cols="6">
                        (Sij. {{ element.super_weekend_bracket_placement }}) (OKa:
                        {{ element.match_average }})
                      </v-col>
                    </v-row>
                  </template>
                </draggable>
            ...
            <v-window-item :key="4" :value="4">
              ...
              <h3 class="pl-10 pt-3">
                Toistaiseksi automatiikka ei toimi, että finaalin tuloksen laitettua Superin tulisi
                tallennettua. Näin voittaja erikseen merkataan muistiin, vaikka superweekend
                turnaustaulussa voittaja näkyisikin
              </h3>
              <v-form
