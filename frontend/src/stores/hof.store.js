...
export const useHofStore = defineStore('hof', () => {
  ...
  const pairWinners = ref([
    ...
    {
      year: 2023,
      first: 'Erik Kuitunen, Totti Sillanpää',
      second: "Mikko 'Temmi' Kuusio, Pasi Kortelainen",
    },
    {
      year: 2022,
      first: 'Erik Kuitunen, Jarno Mikkola',
      second: 'Totti Sillanpää, Veikka Immonen',
    },
  ...
  const hauki = ref([
    ...
    { year: 2021, name: '-' },
    { year: 2020, name: 'Saku Laakkonen' },
    { year: 2019, name: 'Vilppu Penttilä' },
    { year: 2018, name: '?' },
  ...
  const last = ref([
    ...
    { year: 2019, name: 'Yrjö Hakkarainen' },
    { year: 2018, name: '?' },
  ...
  const playoffBest = ref([
    ...
    { year: 2019, name: 'Uki Voutilainen' },
    { year: 2018, name: '?' },
  ...
  const misc = ref([
    ...
    {
      year: 2022,
      name: 'Suurin Sulaminen',
      person:
        'LSP kolme viimeistä mailaa yhteen kyykkään haukia, johtaen häviöön TAI K-Mafian häviö sätkyä vastaan jatkosarjassa.',
    },
    {
      year: 2022,
      name: 'Vuoden Heitto',
      person: 'Elmon kahdeksan kyykän poisto finaalin viimeisen ottelun viimeisessä erässä.',
    },
    { year: 2022, name: 'Vuoden Pettymys', person: 'K-Mafia ei tyhjentänyt' },
    {
      ...
      name: 'Vuoden Onnekas',
      person:
        'Atso Härkönen, kolme kappaletta kolmen kyykän kilkkejä yhden pelipäivän aikana. Myös Lassi.',
    },
  ]);
  ...
  const stars = ref([
    {
      year: 2025,
      first: '⭐ Sami Valjakka, Leevi Nevalainen',
      second: '⭐ Eero Koskikallio, Kaarlo Virtanen',
    },
    {
      year: 2024,
      first: '⭐ Sami Valjakka, Lauri Sorsa',
      second: '⭐ Eino Auvinen, Matias Ylätalo',
    },
    {
      year: 2023,
      first: '⭐ Totti Sillanpää, Juho Sallasmaa',
      second: '⭐ lassi onne, Veeti Sistonen',
    },
    {
      year: 2022,
      first: '⭐ Sami Valjakka, Antti Koivulahti',
      second: '⭐ Jarno Mikkola, Katja Rossi',
    },
    {
      year: 2021,
      first: '⭐ Elmo Pärssinen, Outi Jaakkola',
      second: '⭐ Jarno Mikkola, Vilma Rantanen',
    },
    {
      year: 2020,
      first: '⭐ lassi onne, Markus Laitinen',
      second: '⭐ Heikki Lohilahti, Juho Hautaniemi',
    },
    { year: 2019, first: '⭐ ?, ?', second: '⭐ ?, ?' },
