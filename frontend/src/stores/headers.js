...
export const headerPlayers = [
  ...
  },
  {
    ...
    align: 'center',
    tooltip:
      'Skaalatut Pisteet: S=2n*(h+w)/10, missä h: heittopaikka, w: Heittäjän 1./2. heitoilta 9, 3./4. 13, n: Poistetut kyykät',
  },
  {
    title: 'SPPH',
    key: 'scaled_points_per_throw',
    align: 'center',
    tooltip: 'Skaalatut Pisteet Per Heitto',
    sort: nanSort,
  },
  {
    title: 'kHP',
    key: 'avg_throw_turn',
    align: 'center',
    tooltip: 'Keskimääräinen Heittopaikka',
    sort: nanSort,
  },
  { title: 'H', key: 'pikes_total', align: 'center', tooltip: 'Heitetyt Hauet (Ohi heitto)' },
  {
    ...
    key: 'pike_percentage',
    align: 'center',
    tooltip: 'Hauki prosentti (heityt hauet/kaikki heitot)',
    sort: nanSort,
  },
  {
    title: 'VM',
    key: 'zeros_total',
    align: 'center',
    tooltip: 'Virkamiehet (ei-hauki-nolla-heitto)',
  },
  // { title: 'Tyh.', key: 'clearence_count', width: '1%', align: 'center', tooltip: 'Tyhjennykset (Pelannut tyhjennetyssä erässä)' },
  {
    ...
    key: 'gte_six_total',
    align: 'center',
    tooltip: 'Joulukuuset (yli viiden kyykän heitot)',
  },
];
...
export const headerAllPlayersTemplate = [
  ...
  },
  {
    ...
    key: 'combined_total',
    align: 'center',
    tooltip: 'Kaikki nollaheitot (hauet + virkamiehet)',
  },
  {
    title: 'H%',
    key: 'pike_percentage',
  ...
  },
  {
    ...
    key: 'zero_percentage',
    align: 'center',
    tooltip: 'Virkamies-prosentti (kyykkään osuttu nolla/kaikki heitot)',
    sort: nanSort,
  },
  {
    title: 'H+VM%',
    key: 'combined_percentage',
    align: 'center',
    tooltip: 'Nolla-prosentti (Nollat/kaikki heitot)',
    sort: nanSort,
  },
  {
    title: 'Tyh.',
    ...
    width: '1%',
    align: 'center',
    tooltip: 'Tyhjennykset (Pelannut tyhjennetyssä erässä)',
  },
  {
    title: 'TH',
    key: 'clearence_throws_total',
    width: '1%',
    align: 'center',
    tooltip: 'Tyhjennys heitot (Heitto joka tyhjensi erän)',
  },
  {
    title: 'JK',
    key: 'gte_six_total',
  ...
  { title: 'HP', key: 'throw_turn', tooltip: 'Heittopaikka' },
  {
    ...
    children: [
      // TODO sorting check
      {
        title: '1',
        key: 'score_first',
        tooltip: '1. heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '2',
        key: 'score_second',
        tooltip: '2. heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '3',
        key: 'score_third',
        tooltip: '3. heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '4',
        key: 'score_fourth',
        tooltip: '4. heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
    ],
  },
    ...
    children: [
      {
        title: '1',
        key: 'first',
        tooltip: '1.erän 1.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '2',
        key: 'second',
        tooltip: '1.erän 2.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '3',
        key: 'third',
        tooltip: '1.erän 3.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '4',
        key: 'fourth',
        tooltip: '1.erän 4.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
    ],
  },
    ...
    children: [
      {
        title: '1',
        key: 'fifth',
        tooltip: '2.erän 1.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '2',
        key: 'sixth',
        tooltip: '2.erän 2.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '3',
        key: 'seventh',
        tooltip: '2.erän 3.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
      {
        title: '4',
        key: 'eighth',
        tooltip: '2.erän 4.heitto (Kyykkää)',
        sort: (a, b) => throwSort(a, b),
      },
    ],
  },
...
export const headerPlayerOverallStats = [
  ...
  { title: 'Hauet', key: 'pikes', sortable: false, tooltip: 'Kaikki Hauet (=Ohi heitot)' },
  {
    ...
    key: 'pike_percentage',
    sortable: false,
    tooltip: 'Hauki-prosentti: Hauet / Kaikki heitot',
  },
...
export const headersTeamPlayers = [
  ...
  },
  {
    ...
    width: '1%',
    align: 'center',
    tooltip: 'Heitetyt Hauet (Ohi heitto)',
  },
  {
    title: 'H%',
    key: 'pike_percentage',
...
export const headersTeamMatch = [
  ...
  },
  {
    ...
    key: 'opp_first',
    align: 'center',
    tooltip: 'Vastustaja Joukkueen 1. Erä',
    width: '2%',
  },
  {
    title: 'VJ 2',
    key: 'opp_second',
    align: 'center',
    tooltip: 'Vastustaja Joukkueen 2. Erä',
    width: '2%',
  },
  ...
  // { title: 'JK',          key: 'jotain',              align: 'center', tooltip: '(Joulukuusi) Yhteensä pelissä oman joukkueen heittämät "6 kyykkää tai enemmän"- heitot'},
  {
    ...
    key: 'own_team_total',
    align: 'center',
    tooltip: 'Oman joukkueen pisteet',
    width: '2%',
  },
  {
    title: 'VJ pis.',
    key: 'opposite_team_total',
    align: 'center',
    tooltip: 'Vastustaja joukkueen pisteet',
    width: '2%',
  },
];
...
export const headerHofRecords = [
  ...
  },
  {
    ...
    key: 'throw_order',
    align: 'center',
    tooltip: 'Heittäjän mones heitto',
    sortable: false,
  },
];
...
export const headerHofRecordsPlayerMatch = [...headerHofRecordsPlayerRound.slice(0, -2)];
