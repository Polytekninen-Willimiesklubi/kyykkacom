...
export const useAuthStore = defineStore('auth', () => {
  ...
  /** Check if the user is the captain of the specified team */
  function isTeamCaptain(team: number): boolean {
    if (!loggedIn.value || team === null) {
      return false;
    }
    return isCaptain.value && team === teamId.value;
  }
